 ...
 * 27, 2015
 */
public abstract class FutureBaseCache<K, V, C> {
  ...
  /** . */
  private final Logger log = LoggerFactory.getLogger(FutureBaseCache.class);

  public FutureBaseCache(Loader<K, V, C> loader) {
    this.loader = loader;
